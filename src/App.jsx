      ...
      <div style={{padding:"80px 40px 68px",position:"relative",overflow:"hidden",background:"linear-gradient(180deg,#080f1e 0%,#0a1425 100%)",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
        ...
        <div style={{position:"relative",maxWidth:660}}>
          ...
          <div style={{display:"flex",gap:36}}>
            {[["≥99%",t(lang,"hero_stat2")],["COA",lang==="FR"?"Chaque lot":"Every Batch"],["24h",lang==="FR"?"Expédition":"Dispatch"],["28+",t(lang,"hero_stat1")]].map(([v,l])=>(
              <div key={l}>
...
const FAQPage = ({ lang="EN" }) => {
  ...
  const faqs = lang === "FR" ? [
    ...
    ["Comment les produits sont-ils expédiés ?","Les commandes en stock sont expédiées sous 24h après confirmation du paiement. La livraison prend ensuite 1 à 4 jours en France/UE, et 7 à 14 jours ouvrés hors UE selon la destination."],
    ...
    ["How are products shipped?","In-stock orders are dispatched within 24h of payment confirmation. Delivery then takes 1–4 days within France/EU, and 7–14 business days outside the EU depending on destination."],
